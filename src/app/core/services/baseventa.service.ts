...
export class BaseventaService{
    ...
    getContacts(){
        return [
            new ObjetoModelo('1', 'Tienda San Lucas', new Date(2023, 3, 2), 1000, 50, 10, 'CALI', 0, 0, 0, "src/assets/icons/bolsa-de-la-compra.png"),
            new ObjetoModelo('1', 'Calle 5',  new Date(2023, 3, 2), 2000, 100, 20, 'CALI'),
